    ...
    <main className="mx-auto max-w-5xl px-5 py-14">
      ...
      {orders.length === 0 && (
        <div className="text-muted">
          <p>Chưa có đơn hàng nào hiển thị ở đây.</p>
          <p className="mt-2 text-xs">
            Lưu ý: trang này đọc từ file lưu tạm trên server, có thể không đầy
            đủ khi chạy trên Vercel. Nếu đã bật email đơn hàng
            (RESEND_API_KEY + ORDER_NOTIFY_EMAIL), hãy kiểm tra email để
            chắc chắn không bỏ lỡ đơn nào.
          </p>
        </div>
      )}
